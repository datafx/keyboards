...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( /* Base layer */
    ...
    KC_LCTL,          KC_LGUI,                           KC_SPC,                                      KC_RALT,          MO(1),     KC_LEFT, KC_DOWN, KC_RGHT,   KC_P0,            KC_PDOT
  ),
  [1] = LAYOUT( /* Second layer */
    ...
    _______, CK_TOGG,   CK_UP,  CK_DOWN, CK_RST,  AU_TOG,  MU_TOG,  MU_MOD, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
