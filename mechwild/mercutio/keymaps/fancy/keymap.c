...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_all(
      ...
      KC_LCTL, KC_LALT, KC_LGUI,          MO(1),   MO(2),            KC_SPC,           KC_RGUI, KC_RALT,          KC_RCTL ),

  [1] = LAYOUT_all(
                                                                                                                  KC_TRNS,
          KC_ESC,           KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL,
          KC_TRNS,          KC_TRNS, KC_GRV,  KC_BSLS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LBRC, KC_RBRC, KC_SCLN, KC_SCLN, KC_TRNS,
  ...
  [2] = LAYOUT_all(
          ...
          KC_TRNS, KC_TRNS, KC_TRNS,          KC_HOME, KC_TRNS,          KC_END,           KC_TRNS, KC_TRNS,          KC_PGDN ),
